...
#include<math.h>        //Memanggil library math.h agar dapat menggunakan fungsi-fungsi yang diperlukan, salah satunya fungsi sqrt dan pow
...
/*===============================Variabel yang digunankan===============================*/
    // scanf("%d %d %d %d %d %d %d %d", &kode, &titik1.x, &titik1.y, &titik2.x, &titik2.y, &titik3.x, &titik3.y, &persen); //Meminta inputan user
    // printf("%d %d %d %d %d %d %d %d\n", kode, titik1.x, titik1.y, titik2.x, titik2.y, titik3.x, titik3.y, persen);(untuk pengecekan)
...
//variabel untuk menampung jarak tiap titik
    ...
    float jarak3ke1=0;
//variabel untuk menampung jarak tiap titik
    float s=0, l=0; //untuk menampung nilai keliling dan luas segitiga
    //Perhitungan luas segitiga dengan menggunakan rumus sesuai TEOREMA HERON
    //---------------------------Menghitung jarak antar titik/panjang sisi segitiga---------------------------
    jarak1ke2 = sqrt (pow((titik1.x - titik2.x),2) + pow((titik1.y - titik2.y),2));
    jarak2ke3 = sqrt (pow((titik2.x - titik3.x),2) + pow((titik2.y - titik3.y),2));
    jarak3ke1 = sqrt (pow((titik3.x - titik1.x),2) + pow((titik3.y - titik1.y),2));
    // printf("%f\n%f\n%f\n", jarak1ke2, jarak2ke3, jarak3ke1);
    //---------------------------Menghitung jarak antar titik/panjang sisi segitiga---------------------------
    s=(jarak1ke2+jarak2ke3+jarak3ke1)/2;   
    // printf("Keliling: %f", s);                 //mengitung keliling segitiga
    l=sqrt (s*(s-jarak1ke2)*(s-jarak2ke3)*(s-jarak3ke1));   //menghitung luas segitiga
    float lpersen=l*persen/100;                             //menghitung luas segitiga berdasarkan persentase yang diminta
    printf("Luas: %.2fcm2\n", l);                           //menampilkan luas
