...
//variabel untuk menampung jarak tiap titik
    float tinggi, luas, alas; //untuk menampung nilai keliling dan luas segitiga
    ...
    alas=titik2.x-titik3.x;
    if(alas<0){
        alas*=-1;
    }
    tinggi=titik1.y-titik2.y;
    if(tinggi<0){
        tinggi*=-1;
    }
    // printf("alasnya : %f\ntingginya : %f\n", alas, tinggi);
    //---------------------------Menghitung jarak antar titik/panjang sisi segitiga---------------------------                  //mengitung keliling segitiga
